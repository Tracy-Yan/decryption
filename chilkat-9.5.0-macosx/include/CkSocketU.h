...
class CK_VISIBLE_PUBLIC CkSocketU  : public CkClassWithCallbacksU
{
	...
	// identified by methods having names ending with "Async" and return a task object.
	// 
	const uint16_t *asyncAcceptLog(void);
	...
	// identified by methods having names ending with "Async" and return a task object.
	// 
	const uint16_t *asyncConnectLog(void);
	...
	// identified by methods having names ending with "Async" and return a task object.
	// 
	const uint16_t *asyncDnsLog(void);
	...
	// identified by methods having names ending with "Async" and return a task object.
	// 
	const uint16_t *asyncDnsResult(void);
	...
	// identified by methods having names ending with "Async" and return a task object.
	// 
	const uint16_t *asyncReceivedString(void);
	...
	// identified by methods having names ending with "Async" and return a task object.
	// 
	const uint16_t *asyncReceiveLog(void);
	...
	// identified by methods having names ending with "Async" and return a task object.
	// 
	const uint16_t *asyncSendLog(void);
	...
	// 
	// The caller is responsible for deleting the object returned by this method.
	CkSocketU *AsyncAcceptSocket(void);
	...
	// identified by methods having names ending with "Async" and return a task object.
	// 
	bool AsyncConnectStart(const uint16_t *hostname, int port, bool ssl, int maxWaitMs);
	...
	// identified by methods having names ending with "Async" and return a task object.
	// 
	bool AsyncDnsStart(const uint16_t *hostname, int maxWaitMs);
	...
	// identified by methods having names ending with "Async" and return a task object.
	// 
	bool AsyncReceiveUntilMatch(const uint16_t *matchStr);
	...
	// identified by methods having names ending with "Async" and return a task object.
	// 
	bool AsyncSendString(const uint16_t *stringToSend);
