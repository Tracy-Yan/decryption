...
class CK_VISIBLE_PUBLIC CkFtp2U  : public CkClassWithCallbacksU
{
	...
	// identified by methods having names ending with "Async" and return a task object.
	// 
	bool AsyncAppendFileStart(const uint16_t *localFilename, const uint16_t *remoteFilename);
	...
	// identified by methods having names ending with "Async" and return a task object.
	// 
	bool AsyncGetFileStart(const uint16_t *remoteFilename, const uint16_t *localFilename);
	...
	// identified by methods having names ending with "Async" and return a task object.
	// 
	bool AsyncPutFileStart(const uint16_t *localFilename, const uint16_t *remoteFilename);
	...
	// The caller is responsible for deleting the object returned by this method.
	CkDateTimeU *GetLastAccessDt(int index);

	// Creates an asynchronous task to call the GetLastAccessDt method with the
	// arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *GetLastAccessDtAsync(int index);
	...
	// 
	// The caller is responsible for deleting the object returned by this method.
	CkDateTimeU *GetLastAccessDtByName(const uint16_t *filename);

	// Creates an asynchronous task to call the GetLastAccessDtByName method with the
	// arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *GetLastAccessDtByNameAsync(const uint16_t *filename);
	...
	// value of ListPattern is "*", which will match all filenames.)
	// 
	bool GetLastAccessTimeByName(const uint16_t *filename, SYSTEMTIME &outSysTime);
	...
	// value of ListPattern is "*", which will match all filenames.)
	// 
	bool GetLastAccessTimeByNameStr(const uint16_t *filename, CkString &outStr);
	// Returns a remote file's last-access date/time in RFC822 string format, such as
	// "Tue, 25 Sep 2012 12:25:32 -0500".
	// 
	// Note: The filename passed to this method must NOT include a path. Prior to calling
	...
	// value of ListPattern is "*", which will match all filenames.)
	// 
	const uint16_t *getLastAccessTimeByNameStr(const uint16_t *filename);
	// Returns a remote file's last-access date/time in RFC822 string format, such as
	// "Tue, 25 Sep 2012 12:25:32 -0500".
	// 
	// Note: The filename passed to this method must NOT include a path. Prior to calling
	...
	// value of ListPattern is "*", which will match all filenames.)
	// 
	const uint16_t *lastAccessTimeByNameStr(const uint16_t *filename);

	// Creates an asynchronous task to call the GetLastAccessTimeByNameStr method with
	// the arguments provided. (Async methods are available starting in Chilkat
	// v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *GetLastAccessTimeByNameStrAsync(const uint16_t *filename);
	...
	// directory. The first file/dir is at index 0, and the last one is at index
	// (NumFilesAndDirs-1)
	const uint16_t *getLastAccessTimeStr(int index);
	// Returns the last access date/time (in RFC822 string format, such as "Tue, 25 Sep
	// 2012 12:25:32 -0500") for the Nth file or sub-directory in the current remote
	// directory. The first file/dir is at index 0, and the last one is at index
	// (NumFilesAndDirs-1)
	const uint16_t *lastAccessTimeStr(int index);

	// Creates an asynchronous task to call the GetLastAccessTimeStr method with the
	// arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *GetLastAccessTimeStrAsync(int index);
