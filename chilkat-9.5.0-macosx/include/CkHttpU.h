...
class CK_VISIBLE_PUBLIC CkHttpU  : public CkClassWithCallbacksU
{
	...
	// identified by methods having names ending with "Async" and return a task object.
	// 
	const uint16_t *bgLastErrorText(void);
	...
	// identified by methods having names ending with "Async" and return a task object.
	// 
	const uint16_t *bgResultString(void);
	...
	// 
	bool AddQuickHeader(const uint16_t *headerFieldName, const uint16_t *headerFieldValue);
	...
	CkHttpResponseU *BgResponseObject(void);
	...
	// identified by methods having names ending with "Async" and return a task object.
	// 
	const uint16_t *eventLogName(int index);
	...
	// identified by methods having names ending with "Async" and return a task object.
	// 
	const uint16_t *eventLogValue(int index);
	...
	// 
	bool RemoveQuickHeader(const uint16_t *headerFieldName);
